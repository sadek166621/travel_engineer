             ...
             <div class="col-lg-2 d-flex justify-content-lg-end justify-content-between">
                <div class="header-social social-links">
                   <ul>
                      ...
                      <li><a href="{{ getSetting()->twitter_link }}"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
                      <li><a href="{{ getSetting()->instagram_link }}"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                      <li><a href="{{ getSetting()->linkedin_link }}"><i class="fab fa-linkedin" aria-hidden="true"></i></a></li>
                   </ul>
                </div>
    ...
    <div class="bottom-header">
       <div class="container d-flex justify-content-between align-items-center">
          <div class="site-identity">
             <h1 class="site-title">
                <a href="{{ route('home') }}">
                   <img class="white-logo" src="{{ asset('assets') }}/images/uploads/settings/{{ getSetting()->logo }}" alt="logo">
                   <img class="black-logo" src="{{ asset('assets') }}/images/uploads/settings/{{ getSetting()->logo }}" alt="logo">
                </a>
             </h1>
          </div>
